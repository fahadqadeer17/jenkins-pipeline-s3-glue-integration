...
- Navigate to "Available plugins" and search for "AWS Credentials" and then "S3 Publisher" in the search bar and install. Restart Jenkins once the plugins have been installed.
...
- To map the http endpoint of your Jenkins Server to https for secure transfer of S3 artifacts, we can use "ngrok"
...
![NGROK](/assets/images/ngrok_result.png)

- Repeat the process of adding a webhook to your Github repository by using the Forwarding URL. You will have to generate a new access token in Jenkins.
...
![Lambda Trigger - S3](/assets/images/lambda_add_s3_trigger.png)
